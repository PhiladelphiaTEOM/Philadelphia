...
local NameUser = "[- Philadelphia Source .](https://t.me/lliccc)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"

local NameUserr = "[- Philadelphia Source .](https://t.me/lliccc)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
...
if tonumber(userid) == tonumber(733713096) then
...
send(msg.chat_id_, msg.id_,"[- Philadelphia Source .](https://t.me/lliccc)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "lliccc")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
{{text = '- 𝘉𝘭𝘢𝘤𝘬 𝘛𝘦𝘢𝘮 .',url="t.me/lliccc"}},
...
{{text = '⌔︙ Philadelphia Source  .',url='http://t.me/lliccc'}},
...
{{text = '⌔︙ BLacK 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/lliccc'}},
